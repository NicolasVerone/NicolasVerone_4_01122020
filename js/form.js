...
const birthdateFieldCheck = () => {
    const birthdateInput = document.getElementById("birthdate"); birthdateInput.maxlength = 10;
    ...
    if (birthdateInput.value >= birthdateFieldInputMax || birthdateInput.value < birthdateFieldInputMin) {
